...
function (_Component) {
  ...
  _createClass(Books, [{
    ...
    value: function componentWillMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_2__components_fire__["a" /* default */].database().ref('books/').on("value").then(function (snapshot) {
        var dataArray = [];
        snapshot.forEach(function (childSnapshot) {
          var bookTemp = childSnapshot.val();
          dataArray.push(bookTemp); //this.setState(...)
        });
...
//# sourceMappingURL=5.caca41de3171852c3519.hot-update.js.map