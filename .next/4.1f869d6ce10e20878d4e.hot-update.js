                  ...
                  __WEBPACK_IMPORTED_MODULE_6__components_fire__["a" /* default */].database().ref('books/').once('value', function (snapshot) {
                    ...
                    for (var child in data) {
                      ...
                      if (r.id == book.id) {
                        ...
                        var bookKey = __WEBPACK_IMPORTED_MODULE_6__components_fire__["a" /* default */].database().ref('books/').push(newBook).key; //fire.database().ref('books/' + bookKey + '/key').set(bookKey);
                      } //end of if else
...
//# sourceMappingURL=4.1f869d6ce10e20878d4e.hot-update.js.map