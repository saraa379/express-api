                  ...
                  fire.database().ref('books/').once('value', function (snapshot) {
                    ...
                    for (var child in data) {
                      ...
                      if (r.id == book.id) {
                        ...
                        console.log("Book exist in db"); //var bookKey = fire.database().ref('books/').push(newBook).key;
...
//# sourceMappingURL=4.5167329d7e28b98cac2c.hot-update.js.map