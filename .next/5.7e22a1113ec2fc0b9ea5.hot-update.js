...
function (_Component) {
  ...
  _createClass(Books, [{
    ...
    value: function componentWillMount() {} //fire.database().ref('books/').on('value', this.fbCallback);//end of fire
...
//# sourceMappingURL=5.7e22a1113ec2fc0b9ea5.hot-update.js.map